package com.kapokframework.springmvc.jackson.deser;
...
public class DateDeserializers {
    ...
    public static class TIME extends JsonDeserializer<java.util.Date> {
        @Override
        public java.util.Date deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    public static class DATE_TIME extends JsonDeserializer<java.util.Date> {
        @Override
        public java.util.Date deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    private static java.util.Date _parser(JsonParser p, DeserializationContext ctxt, String format) throws IOException {
...
//            return parsed;
//        }
        return (java.util.Date) ctxt.handleUnexpectedToken(java.util.Date.class, p);
    }
